...
def get_args():
    ...
    parser.add_argument("--checkpoint", type=str, default="https://github.com/davidpiscasio/ee197z-assignments/releases/download/v1.0-kws-transformer/transformer-kws-best-acc.pt")
